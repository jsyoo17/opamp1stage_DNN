'''
1stage opamp simulation function
...
def simulate(opamp):
    ...
    # ************************
    tb_op=circuit.clone(title='testbench operating point')
    ...
    # DC Analysis
    # ***********
    tb_dc=circuit.clone(title='testbench dc')
    ...
    perf['dc_inmax']=dc_inmax

    # ******************
    # Transient Analysis
    # ******************
    tb_tran=circuit.clone(title='testbench tran')
    ...
    # AC Analysis
    # ***********
    tb_ac=circuit.clone(title='testbench ac')
